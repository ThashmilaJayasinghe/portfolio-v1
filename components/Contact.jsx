            ...
            <div className="mx-auto lg:max-w-lg">               
              <div className="isolate rounded-md bg-white mt-10 px-6 py-8 sm:py-6 lg:px-8">  
                <div className="mx-auto max-w-xl gap-x-8 gap-y-6">         
                  ...
                  <div className="mt-8 text-center text-gray-900 text-3xl font-semibold">
                    <p className="mb-2">Connect with me</p>                    
                    <div className="flex items-center justify-center space-x-3">                      
                      <a href="mailto:thashmilajayasinghe@gmail.com" className="w-14 h-14 rounded-md bg-brown-150 px-1.5 py-1.5 shadow-sm hover:bg-brown-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brown-150">
                        <img
                          className=""
                      ...
                      <a href="https://www.linkedin.com/in/thashmila-jayasinghe/" target="_blank" className="w-14 h-14 rounded-md bg-brown-150 px-1.5 py-1.5 shadow-sm hover:bg-brown-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brown-150">
                        <img
                          className=""
                          src="linkedin.svg"
                          alt="LinkedIn"                            
                      ...
                      <a href="https://github.com/ThashmilaJayasinghe" target="_blank" className="w-14 h-14 rounded-md bg-brown-150 px-1.5 py-1.5 shadow-sm hover:bg-brown-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brown-150">
                        <img
                          className=""
                      ...
                      <a href="https://medium.com/@thashmilajayasinghe" target="_blank" className="w-14 h-14 rounded-md bg-brown-150 px-1.5 py-1.5 shadow-sm hover:bg-brown-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brown-150">
                        <img
                          className=""
                          src="medium-m.svg"
                          alt="Medium"
