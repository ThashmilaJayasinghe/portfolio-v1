    ...
    <header className={`h-[11vh] w-screen bg-brown-50 dark:bg-brown-200 fixed z-10 top-0 ${!top && !mobileMenuOpen && 'shadow'}`}>
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div className="hidden lg:flex lg:gap-x-12 lg:justify-end">
          ...
          <a href="https://drive.google.com/file/d/16Eag7TfpWiS6Vx5mPcNMiY-iOpbMIf9g/view?usp=sharing" target="_blank" download="Thashmila_Jayasinghe_resume.pdf" className="rounded-md bg-brown-150 px-3.5 text-sm leading-8 text-white shadow-sm hover:bg-brown-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brown-150">
            Resume
          </a>
        </div>
      </nav>
        ...
        <DialogPanel className="fixed inset-y-0 right-0 z-20 w-full overflow-y-auto bg-brown-50 dark:bg-brown-200 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-brown-150/10">
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              ...
              <div className="py-6">
                <a
                  href="https://drive.google.com/file/d/16Eag7TfpWiS6Vx5mPcNMiY-iOpbMIf9g/view?usp=sharing"
                  target="_blank"
